...
@Component({
  ...
  <button mat-raised-button type="button"    style="color: white;margin-left:15%;background-image: linear-gradient(to top, #0ba360 0%, #3cba92 100%);" class="accordionButton" (click)="showControl();$event.stopPropagation()"><i class="fa fa-plus"></i> Control</button>    
...
export class AccordionItemComponent  {
  ...
  ngAfterViewInit(){
   ...
   // console.log(this.state.currentPage == "weaknesses")
    ...
    //Removed for now:   <button mat-raised-button type="button" style="color: white;margin-left: 15%;background-image: linear-gradient(to top, #0ba360 0%, #3cba92 100%);" class="accordionButton" (click)="showStandard();$event.stopPropagation()"><i class="fa fa-plus"></i>Standard</button>--!    
    //The button/form to add a standard
